...
replace_text "gale/src/lib/config/ConfigFileListItem.svelte" "Are you sure you want to delete \(.\+\)?" "您真的确定要删除 \1 吗？"
...
replace_text "gale/src/lib/menu/OwnedSyncProfilesPopup.svelte" "Are you sure you want to delete \(.\+\) from the database? This will disconnect all subscribers and prevent you from pushing further updates!" "您真的确定要从云端数据库中删除 \1 吗？此操作将断开所有订阅者的连接且无法再次推送更新！"
replace_text "gale/src/lib/menu/OwnedSyncProfilesPopup.svelte" "Deleted sync profile from database." "已从云端数据库中删除同步整合包。"
replace_text "gale/src/lib/menu/OwnedSyncProfilesPopup.svelte" "Owned sync profiles" "我创建的同步整合包"
replace_text "gale/src/lib/menu/OwnedSyncProfilesPopup.svelte" "No profiles found" "未找到相关的整合包"
replace_text "gale/src/lib/menu/OwnedSyncProfilesPopup.svelte" " ago</span" "前</span"
replace_text "gale/src/lib/menu/Syncer.svelte" "Sync off" "关闭同步"
replace_text "gale/src/lib/menu/Syncer.svelte" "Up to date" "已是最新"
replace_text "gale/src/lib/menu/Syncer.svelte" "label: 'Outdated'" "label: '需要更新'"
replace_text "gale/src/lib/menu/Syncer.svelte" "Show owned profiles" "显示我创建的整合包"
replace_text "gale/src/lib/menu/Syncer.svelte" "Sign out" "登出"
...
replace_text "gale/src/lib/menu/Syncer.svelte" "Sign in with Discord" "通过 Discord 登录"
...
replace_text "gale/src/lib/modlist/ModInfoPopup.svelte" "No \(.\+\) found" "未找到 \1"
replace_text "gale/src/lib/modlist/ModInfoPopup.svelte" "Failed to load \(.\+\): " "\1 载入失败："
...
replace_text "gale/src/lib/util.ts" "A moment" "马上就好"
...
replace_text "gale/src/routes/prefs/+page.svelte" "<SmallHeading>Launch</SmallHeading>" "<SmallHeading>启动</SmallHeading>"
